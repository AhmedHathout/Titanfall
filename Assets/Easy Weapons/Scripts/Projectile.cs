...
public class Projectile : MonoBehaviour
{
	...
	public float damage ;										// The amount of damage to be applied (only for Direct damage type)
	public float speed = 100.0f;											// The speed at which this projectile will move
